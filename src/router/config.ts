...
export const DEFAULT_ROUTING_CONFIG: RoutingConfig = {
  ...
  scoring: {
    ...
    // Content creation keywords — when matched, upgrade tier to COMPLEX
    // These indicate the user wants to generate written content (posts, articles, etc.)
    // which benefits from a smarter model vs simple chat replies
    contentCreationKeywords: [
      // English
      "post",
      "posts",
      "article",
